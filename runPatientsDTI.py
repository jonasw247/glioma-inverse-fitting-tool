...
def run(edema, necrotic, enhancing, affine, pet, WM, GM, resultpath):
    ...
    settings["rho0_range"] = 0.15
    settings["dw0_range"] = 0.15
    #settings["thresholdT1c_range"] = fixed
    #settings["thresholdFlair_range"] = fixed
    settings["NxT1_pct0"] = [0,1]
    settings["NyT1_pct0"] = [0,1]
    settings["NzT1_pct0"] = [0,1]
